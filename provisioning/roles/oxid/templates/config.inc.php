 ...
 */
    ...
    /** @name database information */
        ...
        $this->dbName = '{{ oxid_database_name }}'; // database name
        $this->dbUser = '{{ mysql_user_name }}'; // database user name
        $this->dbPwd = '{{ mysql_user_password }}'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://localhost:8080'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '{{ apache_web_root }}';
        $this->sCompileDir = '{{ oxid_tmp_path }}';

    // UTF-8 mode in shop 0 - off, 1 - on
    $this->iUtfMode = {{ oxid_iutfmode }};
